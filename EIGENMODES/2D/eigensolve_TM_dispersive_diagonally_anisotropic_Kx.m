...
function [Hz_modes, Ex_modes, Ey_modes, eigenvals,LHS, RHS] = ...
    eigensolve_TM_dispersive_diagonally_anisotropic_Kx(L0, omega, xrange, ...
    yrange, eps_rx, eps_ry, Npml, neigs, kx_guess)
    ...
    exx = bwdmean_w(eps_0*eps_rx, 'x');  % average eps for eps_x
    eyy = bwdmean_w(eps_0*eps_ry, 'y');  % average eps for eps_y
