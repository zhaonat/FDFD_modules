function [ A, omega,b, Laplacian, sxf, syf] = ...
    solveTE_dirichlet_Matrices(L0, wvlen, xrange, yrange, eps_r, Mz, Npml)
%% Input Parameters
...
Laplacian = Dxf_pml*(Tepx^-1)*Dxb_pml + Dyf_pml*(Tepy^-1)*Dyb_pml;
